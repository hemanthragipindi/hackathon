                  ...
                  <td className="py-4 px-6">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        {op.driverPhone !== '-' && (
                          <p className="text-xs text-gray-500">{op.driverPhone}</p>
                        )}
                      </div>
                    </div>
                  </td>
                  <td className="py-4 px-6">
                    <span className={`inline-block text-xs font-bold px-3 py-1 rounded-full ${op.statusBadge}`}>
                      {op.status}
                    </span>
                  </td>
                  <td className="py-4 px-6 text-right">
                    {op.status === 'Needs Assignment' ? (
                      <button
                        ...
                        className="px-4 py-2 bg-[#064e3b] text-white hover:bg-[#043d2c] rounded-lg text-xs font-bold shadow-xs transition cursor-pointer"
                      >
                        Assign Driver
                      </button>
                    ) : (
                      <button
                        ...
                        className="px-4 py-2 bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 rounded-lg text-xs font-bold shadow-xs transition cursor-pointer"
                      >
                        Track Route
                      </button>
                    )}
