...
import { Users, Utensils, HeartHandshake, Truck, Building2, Bike, Calendar, ChevronDown, Clock, MoreVertical, AlertTriangle } from 'lucide-react';
    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1">Here's what's happening across the FoodResque platform today.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Expiring Alerts */}
        <div className={`flex flex-col gap-6 ${expiringListings.length === 0 ? 'hidden' : ''}`}>
          <div className="bg-orange-50 rounded-xl border border-orange-200 shadow-sm p-5 h-full">
        ...
        {/* Recent Activity */}
        <div className={`bg-white rounded-xl border border-gray-200 shadow-sm p-6 flex flex-col h-full ${expiringListings.length === 0 ? 'lg:col-span-2' : ''}`}>
