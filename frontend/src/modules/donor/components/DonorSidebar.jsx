...
const navItems = [
  ...
  { name: 'Create Donation', icon: PlusCircle, path: '/donor/create' },
  { name: 'My Donations', icon: Utensils, path: '/donor/my-donations' },
  { name: 'Notifications', icon: Bell, path: '/donor/notifications' },
      ...
      <div className="p-4 border-t border-gray-100">
        <div className="flex items-center gap-3 mb-4 px-2">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium text-gray-900 truncate">Green Leaf Rest.</p>
            <p className="text-xs text-gray-500 truncate">Food Donor</p>
          </div>
        </div>
